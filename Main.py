...
output_dir = 'stock_analysis_export'
...
raw_data = yf.download(tickers, start="2016-01-01", end="2026-01-01")

csv_filename = f"{output_dir}/raw_stock_data_2016_2026.csv"
raw_data.to_csv(csv_filename)
print(f"\n[SUCCESS] Raw data exported to: {csv_filename}")
